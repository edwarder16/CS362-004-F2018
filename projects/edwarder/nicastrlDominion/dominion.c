...
void playAdventurer(int currentPlayer, int handPos, struct gameState* state, int drawntreasure, int temphand[], int cardDrawn, int z) {
...
void playMinion(int currentPlayer, int handPos, struct gameState* state, int choice1, int choice2) {
  int i, j;
  //+1 action
  state->numActions++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  {
    case adventurer:
      playAdventurer(currentPlayer, handPos, state, drawntreasure, temphand, cardDrawn, z);
          return 0;
    ...
    case minion:
      playMinion(currentPlayer, handPos, state, choice1, choice2);
          return 0;
